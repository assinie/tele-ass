...
; ----------------------------------------------------------------------------
LCA1D:  clc                                     ; CA1D 18
        lda     #>MAJ_min_str+4                 ; CA1E A9 C6
        adc     #$FF                            ; CA20 69 FF
        sta     VARAPL+8                        ; CA22 85 D8
        lda     #<MAJ_min_str+4                 ; CA24 A9 C2
        adc     #$FF                            ; CA26 69 FF
        sta     VARAPL+9                        ; CA28 85 D9
        jmp     LC9DA                           ; CA2A 4C DA C9

; ----------------------------------------------------------------------------
LCA2D:  ldx     #$FF                            ; CA2D A2 FF
LCA2F:  inx                                     ; CA2F E8
...
; ----------------------------------------------------------------------------
LCCC5:  lda     Flags                           ; CCC5 AD F2 04
        ldy     $04F3                           ; CCC8 AC F3 04
...
SyntaxErr:
        ldx     #$00                            ; CEFE A2 00
        .byte   $2C                             ; CF00 2C
LCF01:  ldx     #$0C                            ; CF01 A2 0C
; Err $0C
OutOfRangeValErr:
        jmp     LCF98                           ; CF03 4C 98 CF

; ----------------------------------------------------------------------------
LCF06:  jsr     CharGet                         ; CF06 20 E2 00
        ...
        pla                                     ; CF1A 68
        bcs     LCF01                           ; CF1B B0 E4
        rts                                     ; CF1D 60

; ----------------------------------------------------------------------------
LCF1E:  jsr     CharGet                         ; CF1E 20 E2 00
...
LCFD2:  lda     #$6E                            ; CFD2 A9 6E
        ...
        jsr     LCA2D                           ; CFED 20 2D CA
        beq     LCFCB                           ; CFF0 F0 D9
        jsr     LCA1D                           ; CFF2 20 1D CA
...
; ----------------------------------------------------------------------------
LD1ED:  cmp     #$4E                            ; D1ED C9 4E
        bne     LD1F5                           ; D1EF D0 04
        lda     #$80                            ; D1F1 A9 80
        bne     LD1DC                           ; D1F3 D0 E7
LD1F5:  cmp     #$41                            ; D1F5 C9 41
...
; ----------------------------------------------------------------------------
LD33F:  jsr     LD1AC                           ; D33F 20 AC D1
LD342:  cmp     #$42                            ; D342 C9 42
        bne     SyntaxErr2                      ; D344 D0 1A
LD346:  jsr     CharGet                         ; D346 20 E2 00
LD349:  jsr     LCEDF                           ; D349 20 DF CE
...
LD922:  cmp     #$23                            ; D922 C9 23
        bne     LD936                           ; D924 D0 10
        jsr     CharGet                         ; D926 20 E2 00
        jsr     LCEDF                           ; D929 20 DF CE
...
LD9A5:  jsr     CharGet                         ; D9A5 20 E2 00
        ...
        jsr     LCF06                           ; D9AC 20 06 CF
        bcc     LD9BD                           ; D9AF 90 0C
LD9B1:  cmp     #$2D                            ; D9B1 C9 2D
        bne     LD9BA                           ; D9B3 D0 05
        jsr     LCF1E                           ; D9B5 20 1E CF
        bcs     LD9BD                           ; D9B8 B0 03
LD9BA:  jsr     LCEDF                           ; D9BA 20 DF CE
...
LASSEM: ldx     #$80                            ; DC0A A2 80
        ...
        ldx     #$00                            ; DC0E A2 00
        stx     Flags                           ; DC10 8E F2 04
        stx     $04F3                           ; DC13 8E F3 04
        ...
        jsr     LD26A                           ; DC34 20 6A D2
        beq     LDC01                           ; DC37 F0 C8
        sta     Flags                           ; DC39 8D F2 04
        sty     $04F3                           ; DC3C 8C F3 04
        txa                                     ; DC3F 8A
...
; ----------------------------------------------------------------------------
LDCA4:  lda     $04F3                           ; DCA4 AD F3 04
        bne     LDCB5                           ; DCA7 D0 0C
        lda     Ptr1                            ; DCA9 AD EE 04
        sta     Flags                           ; DCAC 8D F2 04
        lda     Ptr1+1                          ; DCAF AD EF 04
        sta     $04F3                           ; DCB2 8D F3 04
...
LDD44:  BRK_TELEMON XCRLF                             ; DD44 00 25
        ...
        lda     Flags                           ; DD65 AD F2 04
        ldy     $04F3                           ; DD68 AC F3 04
        ...
        clc                                     ; DD82 18
        lda     Flags                           ; DD83 AD F2 04
        adc     VARAPL+1                        ; DD86 65 D1
        pha                                     ; DD88 48
        lda     $04F3                           ; DD89 AD F3 04
...
LDDA7:  jsr     LC8D1                           ; DDA7 20 D1 C8
        jsr     LC9BF                           ; DDAA 20 BF C9
        cmp     #$4F                            ; DDAD C9 4F
...
; ----------------------------------------------------------------------------
LE3CB:  cmp     #$2C                            ; E3CB C9 2C
        beq     LE3DD                           ; E3CD F0 0E
        jsr     LD26A                           ; E3CF 20 6A D2
...
; ----------------------------------------------------------------------------
LE5C0:  stx     Flags                           ; E5C0 8E F2 04
        sta     $04F3                           ; E5C3 8D F3 04
...
; ----------------------------------------------------------------------------
LE5E3:  lda     Flags                           ; E5E3 AD F2 04
        sta     Ptr1                            ; E5E6 8D EE 04
        sta     Proc1+1                         ; E5E9 8D E3 04
        lda     $04F3                           ; E5EC AD F3 04
...
; ----------------------------------------------------------------------------
LE6A0:  lda     Flags                           ; E6A0 AD F2 04
        sta     Proc1+1                         ; E6A3 8D E3 04
        lda     $04F3                           ; E6A6 AD F3 04
...
LE6BE:  lda     SCRX                            ; E6BE AD 20 02
        ...
        php                                     ; E6C8 08
        clc                                     ; E6C9 18
        lda     Flags                           ; E6CA AD F2 04
        adc     #$08                            ; E6CD 69 08
        sta     Flags                           ; E6CF 8D F2 04
        bcc     LE6D7                           ; E6D2 90 03
        inc     $04F3                           ; E6D4 EE F3 04
LE6D7:  clc                                     ; E6D7 18
...
LE6F4:  jsr     LE7C2                           ; E6F4 20 C2 E7
        lda     Flags                           ; E6F7 AD F2 04
        sta     Ptr2                            ; E6FA 8D F0 04
        lda     $04F3                           ; E6FD AD F3 04
...
LE769:  lda     SCRX                            ; E769 AD 20 02
        ...
        php                                     ; E773 08
        sec                                     ; E774 38
        lda     Flags                           ; E775 AD F2 04
        sbc     #$08                            ; E778 E9 08
        sta     Flags                           ; E77A 8D F2 04
        bcs     LE782                           ; E77D B0 03
        dec     $04F3                           ; E77F CE F3 04
LE782:  sec                                     ; E782 38
...
LE7A2:  jsr     LE7C2                           ; E7A2 20 C2 E7
        lda     Flags                           ; E7A5 AD F2 04
        ldy     $04F3                           ; E7A8 AC F3 04
...
LE7C2:  lda     Proc1+1                         ; E7C2 AD E3 04
        ...
        pha                                     ; E7C9 48
        lda     Flags                           ; E7CA AD F2 04
        ldy     $04F3                           ; E7CD AC F3 04
...
MODIF:  ldx     DEFBNK                          ; E7E8 AE E0 04
        ...
        sta     Flags                           ; E7F1 8D F2 04
        sty     $04F3                           ; E7F4 8C F3 04
        txa                                     ; E7F7 8A
        beq     LE803                           ; E7F8 F0 09
        jsr     LD33F                           ; E7FA 20 3F D3
        stx     $04E1                           ; E7FD 8E E1 04
        tax                                     ; E800 AA
        bne     LE7E5                           ; E801 D0 E2
LE803:  lda     #$0C                            ; E803 A9 0C
...
LE807:  lda     #$00                            ; E807 A9 00
        ...
        ldx     Flags                           ; E816 AE F2 04
        lda     $04F3                           ; E819 AD F3 04
LE81C:  jsr     LE5C0                           ; E81C 20 C0 E5
LE81F:  jsr     LE56F                           ; E81F 20 6F E5
LE822:  jsr     LC8D1                           ; E822 20 D1 C8
        cmp     #$20                            ; E825 C9 20
...
; ----------------------------------------------------------------------------
LE95A:  cmp     #$02                            ; E95A C9 02
        bne     LE991                           ; E95C D0 33
        ldy     #$17                            ; E95E A0 17
        lda     #$00                            ; E960 A9 00
        jsr     LC879                           ; E962 20 79 C8
LE965:  jsr     LC8D1                           ; E965 20 D1 C8
        cmp     #$1B                            ; E968 C9 1B
        ...
        sta     $04E1                           ; E97F 8D E1 04
        lda     Ptr1                            ; E982 AD EE 04
        sta     Flags                           ; E985 8D F2 04
        lda     Ptr1+1                          ; E988 AD EF 04
        sta     $04F3                           ; E98B 8D F3 04
        jmp     LE807                           ; E98E 4C 07 E8

; ----------------------------------------------------------------------------
LE991:  cmp     #$03                            ; E991 C9 03
...
LE9AA:  lda     #<Pile_str                      ; E9AA A9 AF
        ...
        lda     #<Chan0InitTbl                  ; E9B7 A9 E8
        ldy     #>Chan0InitTbl                  ; E9B9 A0 E9
        ldx     #$00                            ; E9BB A2 00
        BRK_TELEMON XSCRSE                             ; E9BD 00 36
        lda     #<Chan1InitTbl                  ; E9BF A9 EE
        ldy     #>Chan1InitTbl                  ; E9C1 A0 E9
        ldx     #$01                            ; E9C3 A2 01
        BRK_TELEMON XSCRSE                             ; E9C5 00 36
        lda     #<Chan2InitTbl                  ; E9C7 A9 F4
        ldy     #>Chan2InitTbl                  ; E9C9 A0 E9
        ldx     #$02                            ; E9CB A2 02
...
LEABE:  jsr     LECF3                           ; EABE 20 F3 EC
        lda     Flags                           ; EAC1 AD F2 04
        bne     LEAE0                           ; EAC4 D0 1A
        cli                                     ; EAC6 58
LEAC7:  jsr     LC8D1                           ; EAC7 20 D1 C8
        cmp     #$20                            ; EACA C9 20
...
LEB44:  jsr     LCF36                           ; EB44 20 36 CF
        cli                                     ; EB47 58
        cld                                     ; EB48 D8
        lda     Flags                           ; EB49 AD F2 04
        beq     LEB51                           ; EB4C F0 03
        jsr     LC8D1                           ; EB4E 20 D1 C8
LEB51:  lda     #<Chan0bInitTbl                 ; EB51 A9 FA
        ldy     #>Chan0bInitTbl                 ; EB53 A0 E9
        ldx     #$00                            ; EB55 A2 00
...
LEB79:  pla                                     ; EB79 68
        ...
        cmp     #$4C                            ; EB83 C9 4C
        bne     LEB8E                           ; EB85 D0 07
        lda     HRS4                            ; EB87 A5 53
        ldy     HRS4+1                          ; EB89 A4 54
        jmp     LEBBB                           ; EB8B 4C BB EB

; ----------------------------------------------------------------------------
LEB8E:  cmp     #$6C                            ; EB8E C9 6C
        bne     LEBA8                           ; EB90 D0 16
        lda     HRS4                            ; EB92 A5 53
...
; ----------------------------------------------------------------------------
LEBA8:  cmp     #$20                            ; EBA8 C9 20
        bne     LEBC4                           ; EBAA D0 18
...
; ----------------------------------------------------------------------------
LEBC4:  cmp     #$40                            ; EBC4 C9 40
        bne     LEBD8                           ; EBC6 D0 10
        tsx                                     ; EBC8 BA
        cpx     #$FC                            ; EBC9 E0 FC
...
; ----------------------------------------------------------------------------
LEBD8:  cmp     #$60                            ; EBD8 C9 60
        bne     LEBF4                           ; EBDA D0 18
        tsx                                     ; EBDC BA
        cpx     #$FD                            ; EBDD E0 FD
...
; ----------------------------------------------------------------------------
LEBF4:  cmp     #$68                            ; EBF4 C9 68
        bne     LEC07                           ; EBF6 D0 0F
        tsx                                     ; EBF8 BA
        cpx     #$FE                            ; EBF9 E0 FE
...
; ----------------------------------------------------------------------------
LEC07:  cmp     #$28                            ; EC07 C9 28
        bne     LEC15                           ; EC09 D0 0A
        cpx     #$FE                            ; EC0B E0 FE
...
; ----------------------------------------------------------------------------
LEC15:  cmp     #$48                            ; EC15 C9 48
        bne     LEC1F                           ; EC17 D0 06
        lda     HRS3                            ; EC19 A5 51
        pha                                     ; EC1B 48
        jmp     LEC26                           ; EC1C 4C 26 EC

; ----------------------------------------------------------------------------
LEC1F:  cmp     #$08                            ; EC1F C9 08
...
SEEK:   ldx     #$00                            ; EE94 A2 00
        ...
        jsr     LEF14                           ; EE98 20 14 EF
        beq     LEEAC                           ; EE9B F0 0F
        jsr     LD1AC                           ; EE9D 20 AC D1
        cmp     #$4C                            ; EEA0 C9 4C
...
; ----------------------------------------------------------------------------
CHANGE: jsr     LEF14                           ; EF4A 20 14 EF
